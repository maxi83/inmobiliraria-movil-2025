...
public class InquilinoAdapter extends RecyclerView.Adapter<InquilinoAdapter.ViewHolderInmueble> {
    ...
    public void onBindViewHolder(@NonNull ViewHolderInmueble holder, int position) {
        ...
        holder.cardView.setOnClickListener(v ->
        {
            ...
            bundle.putSerializable("id_inmueble", inmuebleActual.getIdInmueble());
            Navigation.findNavController((Activity)v.getContext(),R.id.nav_host_fragment_content_main).navigate(R.id.verInquilinoFragment,bundle);
        });
