...
public class ContratoAdapter extends RecyclerView.Adapter<ContratoAdapter.ViewHolderInmueble> {
    ...
    public void onBindViewHolder(@NonNull ViewHolderInmueble holder, int position) {
        ...
        holder.cardView.setOnClickListener(v ->
        {
            ...
            Navigation.findNavController((Activity)v.getContext(),R.id.nav_host_fragment_content_main).navigate(R.id.infoContratoFragment,bundle);
        });
