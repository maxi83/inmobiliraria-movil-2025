...
public class InfoInmuebleViewModel extends AndroidViewModel {


    private MutableLiveData<Inmueble> inmueble = new MutableLiveData<>();
    public InfoInmuebleViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public void actualizarInmueble(Boolean disponible){
        ...
        Call<Inmueble> llamada = ApiClient.getInmobiliariaService().actualizarInmueble("Bearer " + token, inmueble);
